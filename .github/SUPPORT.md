# Getting help with ghtraffic

Thanks for using ghtraffic. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/ghtraffic/issues) to make sure the 
